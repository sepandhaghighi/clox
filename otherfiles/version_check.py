...
README_ITEMS = [
    "[Version {0}](https://github.com/sepandhaghighi/clox/archive/v{0}.zip)",
    "pip install clox=={0}"]

SETUP_ITEMS = [
    "version='{0}'",
    "https://github.com/sepandhaghighi/clox/tarball/v{0}"]

CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/sepandhaghighi/clox/compare/v{0}...dev",
    "[{0}]:"]

PARAMS_ITEMS = ['CLOX_VERSION = "{0}"']
ISSUE_TEMPLATE_ITEMS = ["- Clox {0}"]
