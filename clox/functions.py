...
from .params import FACES_MAP, FACES_LIST, CALENDAR_LIST, DATE_SYSTEM_LIST
...
def main():
    ...
    parser.add_argument('--date-system', help='date system', type=str, choices=DATE_SYSTEM_LIST, default="gregorian")
