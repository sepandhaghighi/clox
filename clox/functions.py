...
def main() -> None:
    ...
    parser.add_argument('--timezones-list', help='timezones list', action='store_true')
    parser.add_argument('--countries-list', help='countries list', action='store_true')
    parser.add_argument('--date-formats-list', help='date formats list', action='store_true')
    parser.add_argument('--no-blink', help='disable blinking mode', action='store_true')
    parser.add_argument('--vertical', help='vertical mode', action='store_true')
    parser.add_argument('--no-date', '--hide-date', dest='hide_date', help='hide date', action='store_true')
    parser.add_argument('--no-timezone', '--hide-timezone', dest='hide_timezone', help='hide timezone', action='store_true')
    parser.add_argument('--12h', '--am-pm', dest='am_pm', help='use 12-hour time format', action='store_true')
    parser.add_argument('--once', help='print current time once and exit immediately', action='store_true')
